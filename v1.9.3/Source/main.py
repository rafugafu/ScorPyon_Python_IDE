...
try:
	...
	def changes(event = None):
		...
		cw = tk.Frame(cw_)
		cw.pack()
		tk.Label(cw, text = '1. Fixed a few bugs').grid(sticky = 'w', column = 0, row = 1, padx = 10, pady = 10)
		tk.Label(cw, text = '2. Added a terminal!').grid(sticky = 'w', column = 0, row = 2, padx = 10, pady = 10)
